...
const Component = ({ placeholder, label, keyboardType, secureTextEntry, value, onChange, errorEmail, errorPassword, errConfirm, maxLength, errName, errUser, onBlur, containerStyle }) => {
    ...
    return (
        ...
        >
            ...
            <TextInput style={styles.fieldInput} containerStyle={containerStyle}
