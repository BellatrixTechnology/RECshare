        ...
        <View style={styling.mainContainer}>
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <View style={styling.availTodayView}>
              <Text style={styling.availTodayTXT}>
            ...
            <View style={styling.availTodayView}>
              ...
              <Checkbox
                ...
                onPress={() => {
                  setcheck('LowestFirst');
                }}
              />
            </View>
            <View style={styling.availTodayView}>
              <Text style={styling.availTodayTXT}>
                {I18n.t('BestReviewedFirst')}
              </Text>
              <Checkbox
